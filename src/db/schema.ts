...
export const backgroundJobs = sqliteTable("background_jobs", {
  id: id(),
  userId: text("user_id").notNull().references(() => users.id, { onDelete: "cascade" }),
  jobType: text("job_type", { enum: ["account_deletion", "agent_run", "listing_check", "watch_refresh", "web_job_search", "resume_parse", "resume_translate", "resume_optimize", "reminder_scan", "search_reindex"] }).notNull(),
