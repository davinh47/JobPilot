...
import { z } from "zod";
import { db } from "@/db";
import { agentRuns, appSettings, candidateProfiles, jobSearchTargets, resumes, resumeVersions, users } from "@/db/schema";
...
export async function analyzeCandidateProfile(userId: string) {
